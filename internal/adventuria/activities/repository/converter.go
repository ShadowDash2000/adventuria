...
func ActivityToRecord(activity *model.Activity, record *core.Record) {
	record.Id = activity.ID()
	record.Set(schema.ActivitySchema.IdDb, activity.IdDb())
	record.Set(schema.ActivitySchema.Type, activity.Type())
	record.Set(schema.ActivitySchema.Name, activity.Name())
	record.Set(schema.ActivitySchema.Slug, activity.Slug())
	record.Set(schema.ActivitySchema.ReleaseDate, activity.ReleaseDate())
	record.Set(schema.ActivitySchema.Platforms, activity.Platforms())
	record.Set(schema.ActivitySchema.Developers, activity.Developers())
	record.Set(schema.ActivitySchema.Publishers, activity.Publishers())
	record.Set(schema.ActivitySchema.Genres, activity.Genres())
	record.Set(schema.ActivitySchema.Tags, activity.Tags())
	record.Set(schema.ActivitySchema.Themes, activity.Themes())
	record.Set(schema.ActivitySchema.GameType, activity.GameType())
	record.Set(schema.ActivitySchema.SteamAppId, activity.SteamAppId())
	record.Set(schema.ActivitySchema.SteamAppPrice, activity.SteamAppPrice())
	record.Set(schema.ActivitySchema.HltbId, activity.HltbId())
	record.Set(schema.ActivitySchema.HltbCampaignTime, activity.HltbCampaignTime())
	record.Set(schema.ActivitySchema.Cover, activity.Cover())
	record.Set(schema.ActivitySchema.CoverAlt, activity.CoverAlt())
	record.Set(schema.ActivitySchema.Checksum, activity.Checksum())
}
