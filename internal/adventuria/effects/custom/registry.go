...
func RegisterEffects(
	...
	effects.Register(
		add_game_genre.NewDef(actions, genres, activities),
		...
		change_game_price_filter.NewDef(actions, cells, activities),
		...
		no_time_limit.NewDef(actions, activities),
		...
		stay_on_cell_after_done.NewDef(actions),
