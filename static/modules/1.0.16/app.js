...
class App {
    ...
    initAnthemPlayer() {
        let anthems = this.audios.getAudiosSrcByEvent('fm');
        if (!anthems) anthems = [];
        ...
        this.anthemPlayer.addEventListener('ended', playNext);
        anthemPrev.addEventListener('click', playPrev);
        anthemNext.addEventListener('click', playNext);
